package subport.api.adapter.out.persistence.emailnotification;
...
import subport.api.application.emailnotification.port.out.LoadEmailNotificationPort;
import subport.api.application.emailnotification.port.out.SaveEmailNotificationsPort;
